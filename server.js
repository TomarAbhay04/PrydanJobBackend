...
/**
 * CORS - allow only production frontend (from env) and localhost dev
 *
 * IMPORTANT:
 * - Set FRONTEND_URL in your Railway env vars to your production frontend WITHOUT a trailing slash,
 *   e.g. https://prydan-job-frontend-isgl.vercel.app
 * - During development localhost will be allowed automatically (http://localhost:5173)
 */
...
// Optional debug: uncomment to log origin attempts (useful if CORS still rejects).
...
/**
 * Health / root route
 * Use GET so we don't accidentally intercept other routes
 */
app.get('/', (req, res) => {
